...
Enter the URL of this GitHub repository, which is:

`ENTER THE URL OF YOUR GITHUB REPOSTIORY HERE`

Select `Username and Password` from the `Authentication` options.

Enter the following credentials into the 'Username' and 'Password' fields respectively:

Username: `PUT YOUR THROWAWAY GITLAB USERNAME BETWEEN THESE BACKTICKS`

Password: `PUT YOUR THROWAWAY GITLAB PASSWORD BETWEEN THESE BACKTICKS`
<p>
